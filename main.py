...
def main():
    ...
    parser.add_argument('--init_client', type=str, default='real', help='noise/real: initialize synthetic images from random noise or randomly sampled real images.')
    parser.add_argument('--init', type=str, default='real', help='noise/real: same, but for the server')
